...
export function QueuePreview() {
  ...
  const queueItems: QueueItem[] = [
    { id: "1", planCode: "24ska01", datacenter: "gra", status: "running", retryCount: 12 },
    { id: "2", planCode: "24sk30", datacenter: "rbx", status: "pending", retryCount: 0 },
    { id: "3", planCode: "24rise01", datacenter: "sbg", status: "running", retryCount: 45 },
  ];
          ...
          queueItems.map((item, index) => (
            ...
            >
              <div className="flex items-center gap-3">
                <span className="text-primary font-mono text-sm">#{item.id}</span>
                <div>
